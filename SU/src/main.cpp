...
//   8 DATA + 1 PARITY.
//   Parity XOR trên protected block 168B (ciphertext + tag) rồi parity được AES-GCM.
...
void loop()
{
    ...
    )
    {
        ...
        if (tong_so_khung_da_ghi == 0)
        {
            Serial.println(">> Khong co audio, bo qua phien rong");
            trang_thai = NGHI_NGOI;
        ...
        )
        {
            ...
            // =============================================
            // PLAINTEXT BLOCK 160B, sau đó được mã hóa thành VOICE packet.
            //
            ...
            {
                Serial.println(">> Dung gui: khong tao duoc VOICE packet");
                gui_that_bai = true;
                break;
            }
            ...
            )
            {
                ...
                {
                    Serial.println(">> Dung gui: khong tao duoc FEC packet");
                    gui_that_bai = true;
                    break;
                }
